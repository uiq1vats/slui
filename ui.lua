...
function ClickEffect(r)
    spawn(
        function()
            ...
            s.ImageColor3 = Color3.fromRGB(80, 80, 255)
            s.Position =
                UDim2.new(
            ...
            b.TweenService:Create(
                ...
                {Position = UDim2.new(-4.5, 0, -4.5, 0), Size = UDim2.new(10, 0, 10, 0)}
            ):Play()
            wait(0.15)
            b.TweenService:Create(s, TweenInfo.new(0.35, Enum.EasingStyle.Exponential, Enum.EasingDirection.Out), {ImageTransparency = 1}):Play()
            repeat
                wait()
...
function a:Window(w)
    ...
    y.BorderSizePixel = 0
    y.Position = UDim2.new(0, 25, 0, -30 + 42 * a.windowCount + 10 * a.windowCount)
    y.Size = UDim2.new(0, 260, 0, 42)
    Drag(y)
    z.Name = "WindowLine"
    z.Parent = y
    z.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
    z.BorderSizePixel = 0
    z.Position = UDim2.new(0, 0, 0, 40)
    z.Size = UDim2.new(0, 260, 0, 2)
    A.Color =
        ColorSequence.new {
    ...
    local function I()
        ...
        b.TweenService:Create(
            ...
            {Size = UDim2.new(0, 260, 0, x and F.AbsoluteContentSize.Y + 8 or 0)}
        ):Play()
        b.TweenService:Create(
            D,
            TweenInfo.new(0.35, Enum.EasingStyle.Exponential, Enum.EasingDirection.InOut),
    ...
    local function J()
        ...
        E.Size.Y.Offset = F.AbsoluteContentSize.Y + 8
    end
    ...
    function K:Button(L, N)
        ...
        O.Size = UDim2.new(0, 250, 0, 42)
        P.Name = "Button"
        P.Parent = O
        P.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        P.BackgroundTransparency = 1.000
        P.BorderSizePixel = 0
        P.Size = UDim2.new(0, 250, 0, 42)
    ...
    function K:Toggle(Q, R, S, N, T)
        ...
        U.Size = UDim2.new(0, 250, 0, 42)
        V.Name = "ToggleText"
        V.Parent = U
        V.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
        V.BackgroundTransparency = 1.000
        V.BorderSizePixel = 0
        V.Size = UDim2.new(0, 250, 0, 42)
        ...
        W.BackgroundColor3 = S and Color3.fromRGB(0, 180, 90) or Color3.fromRGB(180, 60, 60)
        W.BorderSizePixel = 0
                ...
                spawn(
                    function()
                        b.TweenService:Create(
                            W,
                            TweenInfo.new(0.35, Enum.EasingStyle.Exponential, Enum.EasingDirection.InOut),
                            {BackgroundColor3 = T[R] and Color3.fromRGB(0, 180, 90) or Color3.fromRGB(180, 60, 60)}
                        ):Play()
                    end
                )
                spawn(
    ...
    function K:Slider(Y, Z, _, a0, N, S, T)
        ...
        a6.Size = UDim2.new(0, 100, 0, 8)
        a7.CornerRadius = UDim.new(0, 4)
        a7.Name = "SliderBackRound"
        a7.Parent = a6
        a8.Name = "SliderPart"
        a8.Parent = a6
        a8.BackgroundColor3 = Color3.fromRGB(80, 80, 255)
        ...
        local function ab(p)
            ...
            a8:TweenSize(ac, Enum.EasingDirection.InOut, Enum.EasingStyle.Exponential, 0.15, true)
